        ...
        <table className="mx-auto md:mx-0">
          <tbody>
            <tr className="flex md:text-xl">
              <td className="w-16 pr-2 text-right font-semibold">No:</td>
              <td className="w-36 pl-2 text-left md:w-96">{data.set_num}</td>
            </tr>
            <tr className="flex md:text-xl">
              <td className="w-16 pr-2 text-right font-semibold">Name:</td>
              <td className="w-36 pl-2 text-left md:w-96">{data.name}</td>
            </tr>
            <tr className="flex md:text-xl">
              <td className="w-16 pr-2 text-right font-semibold">Year:</td>
              <td className="w-36 pl-2 text-left md:w-96">{data.year}</td>
            </tr>
            <tr className="flex md:text-xl">
              <td className="w-16 pr-2 text-right font-semibold">Parts:</td>
